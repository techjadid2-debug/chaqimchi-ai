...
lint:
	$(PY) -m ruff check enes cloud tests scripts

fmt:
	$(PY) -m ruff format enes cloud tests scripts
...
run-sotqin:
	$(PY) -m uvicorn enes.sotqin_agent:app --host 127.0.0.1 --port 8742
