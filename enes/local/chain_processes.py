...
CHAIN_MODULE = "enes.retail.service"

#: Rebrenddan oldingi nom.  Yangilanish paytida eski versiya hali
#: ishlab turadi va uning zanjiri shu nom bilan yurgan bo'ladi — u ham
#: o'ldirilmasa ikkita zanjir bir kamerani talashardi.
LEGACY_CHAIN_MODULE = "chaqimchi_ai.retail.service"
...
def _powershell_pids() -> List[int]:
    ...
    script = (
        ...
        f"-or $_.CommandLine -like '*{LEGACY_CHAIN_MODULE}*' }} | "
