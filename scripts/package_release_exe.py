...
def generate_pe_header() -> bytes:
    ...
    struct.pack_into("<HBBIIIIIIIIIHHHHHHIIIIHHIIIIII", opt_header, 0,
        0x010B, 6, 0, 0x1000, 0x1000, 0, 0x1000, 0x1000, 0x2000, 0x00400000,
        0x1000, 0x200, 4, 0, 0, 0, 4, 0, 0, 0x3000, 0x200, 0, 2,  # Subsystem 2 = Windows GUI
        0x8000, 0x100000, 0x1000, 0x100000, 0x1000, 0, 16
    )
    ...
    struct.pack_into("<IIIIIIHHI", sec_header, 8, 0x1000, 0x1000, 0x200, 0x200, 0, 0, 0, 0, 0x60000020)
...
def create_setup_exe():
    ...
    print(f"[*] Chaqimchi_AI_Setup.exe yaratilmoqda...")
