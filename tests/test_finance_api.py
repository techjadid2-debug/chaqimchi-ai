...
def finance_client(tmp_path: Path, monkeypatch):
    ...
    monkeypatch.setenv("ENES_COST_SERVER_MONTHLY_USD", "10")
    monkeypatch.setenv("ENES_COST_DOMAIN_YEARLY_UZS", "27000")
    monkeypatch.setenv("ENES_GEMINI_INPUT_USD_PER_M", "0.30")
    monkeypatch.setenv("ENES_GEMINI_OUTPUT_USD_PER_M", "2.50")
    monkeypatch.setenv("ENES_COST_KWH_UZS", "1000")
    monkeypatch.setenv("ENES_DEVICE_WATTS_WINDOWS", "65")
    monkeypatch.setenv("ENES_DEVICE_WATTS_BOX", "12")
